...
CREATE TABLE "pedido" (
  ...
  "metodo_pago" varchar(50), -- HU15: 'efectivo', 'tarjeta', 'transferencia', 'online'
  "estado_pago" varchar(50) DEFAULT 'pendiente', -- HU15: 'pendiente', 'pagado', 'fallido', 'reembolsado'
  "transaccion_id" varchar(200), -- HU15: ID de transacción del gateway de pago
  "fecha_pago" timestamp, -- HU15: fecha y hora del pago
  "created_at" timestamp DEFAULT (now())
);
...
CREATE TABLE "detalle_pedido" (
  ...
  "personalizacion" text -- HU14: JSON o texto con detalles de personalización (sabor, decoración, mensaje, etc.)
);
...
-- HU13 - Tabla de asistencia para control de horarios
CREATE TABLE "asistencia" (
  ...
  "estado" varchar(50) DEFAULT 'pendiente', -- 'pendiente', 'asistio', 'falta', 'tardanza', 'justificado'
  "observaciones" text,
  "created_at" timestamp DEFAULT (now())
);
...
CREATE TABLE "promocion_producto" (
  "id_promocion_producto" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
ALTER TABLE "asistencia" ADD FOREIGN KEY ("id_turno") REFERENCES "turno" ("id_turno") ON DELETE SET NULL;
ALTER TABLE "promocion_producto" ADD FOREIGN KEY ("id_promocion") REFERENCES "promocion" ("id_promocion") ON DELETE CASCADE;
ALTER TABLE "promocion_producto" ADD FOREIGN KEY ("id_producto") REFERENCES "producto" ("id_producto") ON DELETE CASCADE;
